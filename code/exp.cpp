...
IdentifierExp::IdentifierExp(string name) {
   ...
   reservedWords.insert("PRINT");
   reservedWords.insert("IF");
   reservedWords.insert("THEN");
   reservedWords.insert("GOTO");
   reservedWords.insert("END");
   reservedWords.insert("RUN");
   reservedWords.insert("LIST");
   reservedWords.insert("CLEAN");
   reservedWords.insert("QUIT");
   reservedWords.insert("HELP");
   if(reservedWords.contains(name))error("SYNTAX ERROR");
   this->name = name;
}
